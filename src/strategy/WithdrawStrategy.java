...
/**
 * An interface of Withdraw.
 * Any class that implement this interface must write a withdraw method that tell the purse
 * which coin or banknote in purse that choose remove when user withdraw item from purse.
